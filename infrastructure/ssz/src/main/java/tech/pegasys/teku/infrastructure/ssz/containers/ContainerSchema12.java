...
public abstract class ContainerSchema12<
  ...
  public static <
          ...
          V10 extends SszData,
          V11 extends SszData>
      ContainerSchema12<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11> create(
          ...
          BiFunction<
                  ContainerSchema12<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11>,
                  TreeNode,
                  C>
              instanceCtor) {
    return new ContainerSchema12<>(
        fieldSchema0,
        fieldSchema1,
        fieldSchema2,
        fieldSchema3,

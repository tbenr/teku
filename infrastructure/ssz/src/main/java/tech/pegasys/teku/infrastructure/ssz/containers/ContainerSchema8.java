...
public abstract class ContainerSchema8<
  ...
  public static <
          ...
          V6 extends SszData,
          V7 extends SszData>
      ContainerSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7> create(
          ...
          BiFunction<ContainerSchema8<C, V0, V1, V2, V3, V4, V5, V6, V7>, TreeNode, C>
              instanceCtor) {
    return new ContainerSchema8<>(
        fieldSchema0,
        fieldSchema1,
        fieldSchema2,
        fieldSchema3,

...
public class StableContainer3<
        C extends StableContainer3<C, V0, V1, V2>,
        V0 extends SszData,
        V1 extends SszData,
        V2 extends SszData>
    extends AbstractSszImmutableContainer {

  protected StableContainer3(ContainerSchema3<C, V0, V1, V2> schema) {
    super(schema);
  }

  protected StableContainer3(ContainerSchema3<C, V0, V1, V2> schema, TreeNode backingNode) {
    super(schema, backingNode);
  }

  protected StableContainer3(ContainerSchema3<C, V0, V1, V2> schema, V0 arg0, V1 arg1, V2 arg2) {

...
public abstract class ContainerSchema14<
  ...
  public static <
          ...
          V12 extends SszData,
          V13 extends SszData>
      ContainerSchema14<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13> create(
          ...
          BiFunction<
                  ContainerSchema14<C, V0, V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13>,
                  TreeNode,
                  C>
              instanceCtor) {
    return new ContainerSchema14<>(
        fieldSchema0,
        fieldSchema1,
        fieldSchema2,
        fieldSchema3,

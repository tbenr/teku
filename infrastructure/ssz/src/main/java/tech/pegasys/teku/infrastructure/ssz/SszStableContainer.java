 ...
 * is {@link SszData}
 */
public interface SszStableContainer extends SszSparseComposite<SszData> {

  @Override
  SszStableContainerSchema<?> getSchema();

  @SuppressWarnings({"unchecked", "TypeParameterUnusedInFormals"})
  // container is heterogeneous by its nature so making unsafe cast here
  // is more convenient and is not less safe
  default <C extends SszData> Optional<C> getAny(final int index) {
    return (Optional<C>) get(index);
  }
}

...
public class SszMutableStableContainerImpl extends AbstractSszMutableComposite<SszData, SszMutableData>
    implements SszMutableRefContainer {

  public SszMutableStableContainerImpl(final SszContainerImpl backingImmutableView) {

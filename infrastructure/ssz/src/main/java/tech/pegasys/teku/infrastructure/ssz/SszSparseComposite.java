 ...
 */
public interface SszSparseComposite<SszChildT extends SszData> extends SszData {
   ...
   */
  Optional<SszChildT> get(int index);

  @Override
  SszSparseCompositeSchema<?> getSchema();

  @Override
  SszMutableSparseComposite<SszChildT> createWritableCopy();
}

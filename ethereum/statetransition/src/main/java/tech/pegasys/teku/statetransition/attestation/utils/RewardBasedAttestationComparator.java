...
public class RewardBasedAttestationComparator {
  ...
  public static RewardBasedAttestationComparator create(final Spec spec, final BeaconState state) {
    ...
    return new RewardBasedAttestationComparator(
        spec,
  ...
  private RewardBasedAttestationComparator(
      final Spec spec,
  ...
  private UInt64 getRewardNumeratorForAttestation(
      final BeaconStateAltair state, final Attestation attestation) {
  ...
  public Comparator<ValidatableAttestation> comparator() {
    return (a1, a2) ->
        getRewardNumeratorForAttestation(state, a1.getAttestation())
            .compareTo(getRewardNumeratorForAttestation(state, a2.getAttestation()));
  }
}
